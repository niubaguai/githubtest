...
public class CodeUtil {
    ...
    private static final String CLASS_TPYE="GXUN";
    ...
    public static String classCode(String oriStr,int len,String alexin){
        return CLASS_TPYE+padRight(oriStr, len, alexin);
    }
